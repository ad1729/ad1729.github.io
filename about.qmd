...
The primary reason for starting this (mostly) technical blog is to work through some (technical) concepts or challenges I encounter. Additional reasons include having my R / Python code in a clean and easy-to-navigate format, and to share recipes (food, not code) once in a while. I've been talking about wanting to have a blog since 2012, so I'm glad that I _finally_ got around to having one in 2022.
